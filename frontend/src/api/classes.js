...
export const resetStudentPassword = (classId, stuId) => client.patch(`/classes/${classId}/students/${stuId}/reset-pw`);
export const getDailyCheckin      = classId          => client.get(`/classes/${classId}/checkin`);
